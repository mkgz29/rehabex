// Handler logic for the admin secure-media routes. Lives outside api/ so it
// counts as zero Vercel Serverless Functions on its own; api/admin/[...path].ts
// is the single function that dispatches by path.
...
import { FOLDER_BY_INTENT, isValid, mimeTypeForFormat, parseMediaFinalizePayload, parseMediaSignPayload, validateResourceMetadata } from '../mediaValidators.js';

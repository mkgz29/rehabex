...
export function NewsletterSection() {
  return (
    <section className="bg-canvas pb-[var(--space-section)]">
      <div className="site-container">
        <div className="grid gap-8 overflow-hidden rounded-card border border-white/10 bg-primary px-6 py-10 text-white shadow-soft sm:px-10 sm:py-12 lg:grid-cols-[1fr_0.8fr] lg:items-center lg:px-14">
          <div data-reveal-item>
            <div className="flex h-11 w-11 items-center justify-center rounded-control bg-white/10 text-accent-soft">
          ...
          <form data-reveal-item className="lg:justify-self-end" aria-label="Suscripción a novedades" aria-describedby="newsletter-status" onSubmit={(event) => event.preventDefault()}>

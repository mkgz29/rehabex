...
export function HeroSection() {
  ...
  return (
    <section className="relative isolate overflow-hidden">
      ...
      <div className="mx-auto grid w-full max-w-7xl gap-10 px-4 py-14 sm:px-6 sm:py-20 lg:grid-cols-[minmax(0,1fr)_minmax(320px,480px)] lg:items-center lg:px-8 lg:py-24">
        ...
        <div>
          <div className="overflow-hidden rounded-[2rem] border border-white/70 bg-white/70 p-3 shadow-[0_24px_80px_rgba(15,23,42,0.16)] backdrop-blur transition">

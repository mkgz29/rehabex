      ...
      <main className="px-4 py-14 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        <section className="mx-auto flex w-full max-w-3xl flex-col items-start">
          ...
          <div className="mt-8 flex w-full flex-col gap-3 sm:w-auto sm:flex-row">
            ...
            <button type="button" onClick={payment.refresh} className="inline-flex items-center justify-center rounded-full border border-slate-300 px-5 py-3 text-sm font-semibold text-slate-700 transition hover:border-slate-900 hover:text-slate-950">Consultar nuevamente</button>
          </div>
        </section>
      </main>
      <Footer />
